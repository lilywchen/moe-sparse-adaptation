...
| Cell-DINO RxRx1 implementation and checkpoint are valid; competence diagnostics launched | validated implementation; diagnostic performance pending | RxRx1 / competence gate | GitHub `db9ebdb`; SciServer checkout `moe-sparse-adaptation-run-db9ebdb-v2`; checkpoint `models/cell_dino/cell_dino_vits8_pretrain_cp-37d20e9c.pth`; runs `rxrx1_original_ep5_s0_linear_probe` and `rxrx1_original_ep10_s0_full_ft_lr1e-4`; queued `...full_ft_lr3e-4`; W&B `lvyxc7my`, `y82kwuxm` | GitHub and SciServer tree `c537d33ef4db3dc2206c0922a0159b4b19095adc`; SciServer `4c1a0ab2`; DINOv2 `7764ea0`; checkpoint SHA-256 `37d20e9cd48b3d610b5de15a4ea4e7e060a593b8d8358e928d079dc7b03ee66a` | train/ID/OOD validation only; startup states test untouched; all results must record `selection_split=ood_val`, `test_evaluated=false` | 80/80 tests; safe weights-only load; real-checkpoint `1x5x128x128 -> 1x1139` smoke; 3/3 dry-run pending; no duplicates; GPUs 0/1 at 99% with exact direct workers and fresh logs | licenses completion/validation of the three competence diagnostics, not MoE comparison |
