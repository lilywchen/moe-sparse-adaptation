...
Last verified: 2026-07-31 23:44 EDT
...
| Official-pooling Cell-DINO competence rerun launched | pending diagnostic | RxRx1 / competence repair | three arms under `kill_rxrx1/official_pool/competence/`; isolated checkout `/home/idies/workspace/Storage/lchen5/persistent/moe-sparse-adaptation-run-04986fe` | GitHub `04986fe`; code-equivalent SciServer `f57743d`, tree `289390c317910c0a1f8839832405c80f32b5ac3e`; DINOv2 `7764ea0`; checkpoint SHA-256 `37d20e9cd48b3d610b5de15a4ea4e7e060a593b8d8358e928d079dc7b03ee66a` | train/ID/OOD validation only; OOD test untouched | 84/84 tests; real-checkpoint smoke confirms 768-dimensional CLS-plus-mean-patch representation; no duplicate or existing result; three processes have fresh logs and expected GPU ownership | final bounded Cell-DINO instrument decision after 3/3 strict results validate |
