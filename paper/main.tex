...
adaptation of a pretrained vision encoder under acquisition shift. We upcycle one feed-forward
block of DINOv2 ViT-S/14 and compare it with an exactly initialized, total-parameter-matched dense
block on RxRx1 and Camelyon17. A predeclared $3\times2\times2\times3$ factorial varies placement,
