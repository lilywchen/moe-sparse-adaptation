...
1 and 2. At the locked epoch-60 endpoint, sparse minus dense changes
OOD-validation/ID/worst-experiment accuracy by $+1.17/+1.78/+0.20$ points for seed 1 and
$+1.06/+2.59/+0.28$ points for seed 2, averaging $+1.11/+2.19/+0.24$ points. The signs align
across both fresh seeds and all three decision axes, satisfying the predeclared smaller-mean plus
consistent-tail alternative, but the mean OOD effect remains far below five points. This is
decision-grade confirmation for the exact locked recipe, not a population-wide or search-free
claim: the recipe was selected across preceding seed-0 factorial, router-auxiliary, and
temperature screens, only two fresh seeds are available, and the OOD test remains untouched.
